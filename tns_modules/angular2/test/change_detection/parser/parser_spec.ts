  ...
  describe("parser", () => {
    describe("parseAction", () => {
      ...
      describe("member access", () => {
        ...
        it("should fall back to a regular field read when Locals " + "does not have the requested field", () => {
      ...
      describe("method calls", () => {
        ...
        it('should fall back to the parent context when Locals does not ' + 'have the requested method', () => {
          var locals = new Locals(null, MapWrapper.create());
