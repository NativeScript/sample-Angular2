...
import {View,
  ProtoView} from 'angular2/src/core/compiler/view';
...
import {ProtoElementInjector,
  ElementInjector} from 'angular2/src/core/compiler/element_injector';
...
export function main() {
  describe('ViewContainer', () => {
    ...
    beforeEach(() => {
      ...
      protoView = new ProtoView(el('<div>hi</div>'), new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
    ...
    describe('should update injectors and parent views.', () => {
      ...
      beforeEach(() => {
        ...
        viewContainer.hydrate(new Injector([]), null, null);
        var pv = new ProtoView(el('<div class="ng-binding">{{}}</div>'), new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
      ...
      it('hydrating should update rootElementInjectors and parent change detector', () => {
        ...
        ListWrapper.forEach(fancyView.rootElementInjectors, (inj) => expect(inj.parent).toBe(elementInjector));
      ...
      it('dehydrating should update rootElementInjectors and parent change detector', () => {
        viewContainer.insert(fancyView);
        viewContainer.remove();
        ListWrapper.forEach(fancyView.rootElementInjectors, (inj) => expect(inj.parent).toBe(null));
...
//# sourceMappingURL=view_container_spec.js.map
