...
import {EmulatedScopedShadowDomStrategy,
  ...
  describe('view', function() {
    ...
    describe('instantiated and hydrated', function() {
      function createCollectDomNodesTestCases(useTemplateElement) {
        ...
        it('should collect the root node in the ProtoView element', () => {
          var pv = new ProtoView(templateAwareCreateElement('<div id="1"></div>'), new DynamicProtoChangeDetector(null, null), null);
        ...
        describe('collect elements with property bindings', () => {
          it('should collect property bindings on the root element if it has the ng-binding class', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div [prop]="a" class="ng-binding"></div>'), new DynamicProtoChangeDetector(null, null), null);
          ...
          it('should collect property bindings on child elements with ng-binding class', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div><span></span><span class="ng-binding"></span></div>'), new DynamicProtoChangeDetector(null, null), null);
            pv.bindElement(null, 0, null);
        ...
        describe('collect text nodes with bindings', () => {
          it('should collect text nodes under the root element', () => {
            var pv = new ProtoView(templateAwareCreateElement('<div class="ng-binding">{{}}<span></span>{{}}</div>'), new DynamicProtoChangeDetector(null, null), null);
            pv.bindElement(null, 0, null);
      ...
      describe('inplace instantiation', () => {
        it('should be supported.', () => {
          ...
          var pv = new ProtoView(template, new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
      ...
      describe('create ElementInjectors', () => {
        ...
        it('should use the correct parent', () => {
          var pv = new ProtoView(el('<div class="ng-binding"><span class="ng-binding"></span></div>'), new DynamicProtoChangeDetector(null, null), null);
      ...
      describe('collect root element injectors', () => {
        ...
        it('should collect multiple root element injectors', () => {
          var pv = new ProtoView(el('<div><span class="ng-binding"></span><span class="ng-binding"></span></div>'), new DynamicProtoChangeDetector(null, null), null);
          pv.bindElement(null, 0, new ProtoElementInjector(null, 1, [SomeDirective]));
      ...
      describe('with component views', () => {
        ...
        function createComponentWithSubPV(subProtoView) {
          var pv = new ProtoView(el('<cmp class="ng-binding"></cmp>'), new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
        ...
        it('should expose component services and component instance to directives in the shadow Dom', () => {
          var subpv = new ProtoView(el('<div dec class="ng-binding">hello shadow dom</div>'), new DynamicProtoChangeDetector(null, null), null);
          subpv.bindElement(null, 0, new ProtoElementInjector(null, 0, [ServiceDependentDecorator]));
          var pv = createComponentWithSubPV(subpv);
          var view = createNestedView(pv);
      ...
      describe('react to record changes', () => {
        ...
        it('should notify a directive about changes after all its properties have been set', () => {
          var pv = new ProtoView(el('<div class="ng-binding"></div>'), new DynamicProtoChangeDetector(null, null), null);
          pv.bindElement(null, 0, new ProtoElementInjector(null, 0, [DirectiveBinding.createFromType(DirectiveImplementingOnChange, new DummyDirective({lifecycle: [onChange]}))]));
    ...
    describe('protoView createRootProtoView', () => {
      ...
      beforeEach(() => {
        ...
        pv = new ProtoView(el('<div>hi</div>'), new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
      });
      it('should create the root component when instantiated', () => {
        var rootProtoView = ProtoView.createRootProtoView(pv, element, someComponentDirective, new DynamicProtoChangeDetector(null, null), new NativeShadowDomStrategy(null));
