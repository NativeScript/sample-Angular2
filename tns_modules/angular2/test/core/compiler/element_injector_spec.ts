...
import {ProtoView,
  View} from 'angular2/src/core/compiler/view';
  ...
  describe("ElementInjector", function() {
    ...
    describe("createPrivateComponent", () => {
      ...
      it("should not inject the proxy component into the children of the private component", () => {
        ...
        expect(() => shadowDomInj.instantiateDirectives(appInjector, null, defaultPreBuiltObjects)).toThrowError(new RegExp("No provider for SimpleDirective"));
      });
      ...
      it("should support rehydrating the private component", () => {
        var inj = injector([]);
        inj.createPrivateComponent(DirectiveWithDestroy, new DummyDirective({lifecycle: [onDestroy]}));
    ...
    describe('event emitters', () => {
      ...
      it('should be injectable and callable', () => {
        var called = false;
        var preBuildObject = createpreBuildObject('click', (e, view) => {
          called = true;
        });
