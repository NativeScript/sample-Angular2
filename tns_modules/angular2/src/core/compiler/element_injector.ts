...
export class DirectiveDependency extends Dependency {
  constructor(key, asPromise, lazy, optional, properties, depth, eventEmitterName, propSetterName, attributeName) {
...
export class PreBuiltObjects {
  constructor(view, element, viewContainer, bindingPropagationConfig) {
    this.view = view;
...
export class ElementInjector extends TreeNode {
  ...
  createPrivateComponent(componentType, annotation) {
